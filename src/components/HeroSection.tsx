        ...
        <Grid container spacing={6} alignItems="center" className="hero-grid">
          <Grid item xs={12} md={7} className="hero-content-grid">
            <Box className="hero-content">
              <Box sx={{ mb: 4, display: 'flex', alignItems: 'center' }} className="hero-logo-container">
                <img 
          ...
          <Grid item xs={12} md={5} className="hero-image-grid">
            <Box 
